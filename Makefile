...
export TERRAFORM_NATIVE_PROVIDER_BINARY := terraform-provider-github_v3.10.0
...
#   You can check the basic implementation here: https://github.com/upbound/uptest/blob/main/internal/vcds/01-delete.yaml.tmpl.
